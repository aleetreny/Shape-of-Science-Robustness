...
| 4. Descripciones de las áreas | El orden por apertura o direcciones puede cambiar con el encoder, pese a su estabilidad al repetir la selección. | [02_field_rank_maps.pdf](reports/morphology_pilot_v1/02_field_rank_maps.pdf) |
...
- Figura 4: mismos 52.000 artículos, 2.000 por área y fechas equilibradas; posiciones entre 26 áreas dentro de cada modelo. Mayor posición significa mayor valor, no mejor representación. Apertura no es diversidad temática y PR no cuenta temas. Piloto exploratorio posterior; conservar controles de tamaño, selección, receta y centrado. El ejemplo Artes/Medicina fue elegido tras ver los resultados.
...
Con R01–R12 y el piloto verificados, el siguiente encargo puede ser redactar usando [METHODS_ROBUSTNESS.md](METHODS_ROBUSTNESS.md), los dos métodos anteriores y [METHODS_MORPHOLOGY.md](METHODS_MORPHOLOGY.md). No ampliar automáticamente las entradas a 500.000 ni repetir inferencia por abrir otro chat. Un análisis adicional debe responder a una afirmación esencial todavía insuficientemente apoyada.
