...
**18-09-2026. Esquema desarrollado por petición del usuario. No es un manuscrito.**

Guía operativa vigente: [MANUSCRIPT_BLUEPRINT.md](MANUSCRIPT_BLUEPRINT.md), con 48 párrafos de trabajo, títulos, posición de tablas/figuras, evidencia y suplemento. Leer junto a [AUTHOR_VOICE.md](AUTHOR_VOICE.md), basada en las 50 entradas del portfolio. Este documento conserva la vista general; el plano detallado explica la procedencia de la redacción. El título fue confirmado el 19-09-2026; el texto final sigue sujeto a revisión del autor. [Tres alternativas de voz](MANUSCRIPT_VOICES.md) permanecen pendientes de elección.
...
Título conservado por decisión del autor, 19-09-2026: **How much does the map of science depend on the embedding model?**
...
El usuario pidió desarrollar este esquema y conservar su voz. Esa preparación está en [el plano detallado](MANUSCRIPT_BLUEPRINT.md) y [la guía del autor](AUTHOR_VOICE.md). Cuando se pida redactar, empezar por métodos/resultados y después discusión, introducción, título/resumen. Esta preparación no necesita nuevos cálculos. Mantener [NEXT_STEPS.md](NEXT_STEPS.md) y [QSS_CHECK.md](docs/QSS_CHECK.md) como continuidad.
