...
def write(item, content, selection):
    ...
    if editorial.exists():
        ...
        selection = ('Question-first explanation reviewed on 20 September 2026; sizes and model settings '
                     'are unchanged. Detailed group-size controls remain in main methods and S1--S4.')
