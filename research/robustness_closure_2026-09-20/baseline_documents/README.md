...
**Estado · 20 septiembre 2026:** el autor ha elegido la voz 2 y el [manuscrito se ha reescrito para explicar el estudio con más claridad](MANUSCRIPT_CLARITY.md), en inglés y español. El texto presenta cada pregunta antes de sus medidas y distingue las muestras por su finalidad. Se conservan título, resultados y versiones anteriores. Inglés: 3.989 palabras de cuerpo y 192 de resumen. La revisión personal y el depósito de datos siguen pendientes. [Estado exacto y continuación →](NEXT_STEPS.md)
...
| Leer el artículo y suplemento vigentes | [Reescritura clara, PDF y fuentes](MANUSCRIPT_CLARITY.md) |
