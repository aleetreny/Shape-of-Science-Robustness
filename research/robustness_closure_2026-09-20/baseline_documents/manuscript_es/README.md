...
Traducción completa del borrador inglés revisado el 20-09-2026: artículo, suplemento, tablas, notas y rótulos de las 14 figuras. Se conserva su organización, numeración, cifras, fórmulas, referencias y límites. No es un resumen ni una nueva versión de los resultados.

- Artículo: `../output/pdf/es/main.pdf` (20 páginas).
- Suplemento: `../output/pdf/es/supplement.pdf` (36 páginas).
