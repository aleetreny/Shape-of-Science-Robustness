...
**Actualización del depósito, 21-09-2026:** [paquete de 32 archivos, sin artículos ni suplementos](ZENODO_UPLOAD.md). Los datos y programas científicos se conservan; el ZIP de código para Zenodo termina en `-data-only.zip`. La narrativa del artículo puede seguir revisándose por separado. Borrador de Zenodo aún sin archivos publicados.
