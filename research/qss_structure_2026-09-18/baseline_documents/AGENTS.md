...
**Estado vigente, 18-09-2026:** resumen final de las 325 parejas terminado; piloto de morfología, revisión, atlas y cierre R01–R12 conservados. Leer `FIELD_PAIR_RESULTS.md`, `METHODS_FIELD_PAIRS.md`, `MORPHOLOGY_RESULTS.md`, `NEXT_STEPS.md` y el final de `progress.md`/`DECISIONS.md`. El usuario quiere discutir ahora la organización del manuscrito. Las medidas describen geometría, no verdad temática. Mantener alertas y errores de OpenAlex; no reiniciar cálculos ni redactar automáticamente.
