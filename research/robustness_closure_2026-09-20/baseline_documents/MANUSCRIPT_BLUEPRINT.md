...
**Redacción vigente, 20-09-2026:** [MANUSCRIPT_CLARITY.md](MANUSCRIPT_CLARITY.md). El autor ha elegido V2 y pedido una explicación más sencilla. Las seis secciones principales se conservan; sus apartados presentan ahora preguntas y hallazgos concretos. La tabla de muestras empieza por su propósito. Los detalles técnicos y sus fuentes se mantienen en el suplemento. Cuerpo inglés: 3.989 palabras, sin rellenar el presupuesto inicial. El esquema de párrafos de abajo es histórico y sirve para seguir la evidencia, no para volver a imponer aquella redacción.
...
**Actualización de redacción, 18-09-2026:** el usuario pidió después completar y revisar todo el artículo. El cuerpo final del borrador tiene 4.383 palabras: 368 de introducción, 627 de antecedentes, 1.172 de métodos, 1.444 de resultados, 663 de discusión y 109 de conclusión. El resumen tiene 190. La tabla de 6.750 palabras de abajo se conserva como presupuesto histórico, no objetivo que deba rellenarse. La discusión se concentra en tres apartados y la sección 3.5 se titula `Sequence of checks`. Estado vigente: [MANUSCRIPT_REVIEW.md](MANUSCRIPT_REVIEW.md). Los planes de párrafo posteriores explican la procedencia, no indican prosa pendiente.
...
Título conservado por decisión del autor el 19-09-2026: **How much does the map of science depend on the embedding model?** Las [tres alternativas de voz](MANUSCRIPT_VOICES.md) mantienen ese título; el autor eligió V2 el 20-09 y pidió la reescritura clara vigente. “Science maps” se define como relaciones en los espacios de representación; no evaluamos el parecido visual de proyecciones bidimensionales.
