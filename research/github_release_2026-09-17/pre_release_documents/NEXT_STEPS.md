...
4. Antes de enviar, completar [QSS_CHECK.md](docs/QSS_CHECK.md) y el [depósito de datos/código](docs/DATA_RELEASE.md). No se han publicado archivos, elegido una licencia general ni hecho un envío.
