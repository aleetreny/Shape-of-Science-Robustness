...
**Estado vigente, 18-09-2026:** tablas, figuras y maqueta LaTeX/PDF preparadas por petición directa. Leer `MANUSCRIPT_LAYOUT.md`, `manuscript/README.md`, `MANUSCRIPT_BLUEPRINT.md`, `AUTHOR_VOICE.md` y `NEXT_STEPS.md`. Son dos tablas y cuatro figuras principales, 17 grupos de tablas y diez figuras suplementarias. El texto sigue marcado como plan: no se ha redactado el artículo completo. Es una maqueta propia para primera entrega flexible, no una plantilla oficial QSS localizada. Conservar alertas y errores de OpenAlex; no reiniciar cálculos ni redactar automáticamente.
...
- Esta petición autoriza preparar estructura/voz, no redactar automáticamente el artículo completo. Cuando se pida redacción, comenzar por métodos/resultados y comprobar la adaptación de la voz en el primer bloque. Título final, autoría, depósito, licencia y envío no se rellenan por suposición.
