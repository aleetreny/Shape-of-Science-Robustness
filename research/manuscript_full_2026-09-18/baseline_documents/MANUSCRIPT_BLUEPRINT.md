...
**Actualización de redacción, 18-09-2026:** el autor pide empezar por secciones 1 y 2 y mantener el paper breve. El primer borrador ocupa 367 + 627 palabras de prosa, frente a las 1.550 previstas abajo. La tabla conserva el presupuesto inicial como referencia; no obliga a rellenar espacio. Texto actual en [main.tex](manuscript/main.tex); revisión de afirmaciones en [el registro de apertura](research/manuscript_opening_2026-09-18/CLAIM_REVIEW.md). Las demás secciones siguen por redactar.
