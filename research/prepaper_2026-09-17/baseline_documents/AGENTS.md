...
**Estado vigente, 17-09-2026:** cierre experimental ampliado terminado y auditado; R01–R12 verificados. Leer `ROBUSTNESS_RESULTS.md`, `NEXT_STEPS.md` y el final de `progress.md`/`DECISIONS.md`. Entradas en 52k, Subfields y controles completos. Las secciones de trabajo activo anteriores son históricas; no reiniciar cálculos ni redactar automáticamente.
