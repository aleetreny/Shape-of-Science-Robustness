...
**Estado vigente, 18-09-2026:** plano detallado de escritura y voz del autor preparados por petición del usuario. Leer `MANUSCRIPT_BLUEPRINT.md`, `AUTHOR_VOICE.md`, `NEXT_STEPS.md` y el final de `progress.md`/`DECISIONS.md`. El plano organiza 48 párrafos, dos tablas y cuatro figuras principales; no se ha redactado el manuscrito. Revisión QSS y cierres científicos, atlas, morfología y 325 parejas conservados. Las medidas describen geometría, no verdad temática. Mantener alertas y errores de OpenAlex; no reiniciar cálculos ni redactar automáticamente.
