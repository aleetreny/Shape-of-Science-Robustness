...
OUT = ROOT / 'data/robustness_v2/control_review_v2'
...
def control_stats():
    ...
    for k in [10,25,50]:
        add('minilm_neighbor_change.csv',f'minilm512_vs_other_models_k{k}','delta_overlap',lambda r:int(r['k'])==k and r['other_model']!='minilm')
        add('minilm_neighbor_change.csv',f'minilm512_vs_itself_k{k}','delta_overlap',lambda r:int(r['k'])==k and r['other_model']=='minilm')
...
def main():
    with run_lock(OUT):
        ...
        freeze(OUT,['sos_deep/control_review_v2.py','sos_deep/artifacts.py','sos_analysis/run_shape.py'],
