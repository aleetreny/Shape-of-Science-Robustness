...
**Estado · 18 septiembre 2026:** análisis y revisión terminados; ya hay una [maqueta renderizada del artículo y suplemento](MANUSCRIPT_LAYOUT.md), con las tablas y figuras colocadas. La prosa completa sigue pendiente. La fragmentación no queda resuelta por un índice único; el depósito de datos sigue pendiente. [Estado exacto y continuación →](NEXT_STEPS.md)
