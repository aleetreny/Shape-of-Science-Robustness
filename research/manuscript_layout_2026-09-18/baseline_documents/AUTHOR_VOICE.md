...
Leer primero esta guía y [MANUSCRIPT_BLUEPRINT.md](MANUSCRIPT_BLUEPRINT.md). Construir cada bloque con sus fuentes y cifras verificadas. Al solicitarse la redacción, empezar por métodos y resultados; comprobar después la voz en un bloque manejable antes de extenderla a todo el texto. La preferencia de voz está aceptada; el título final, autoría y texto completo siguen pendientes de su revisión. No reinterpretar esta preparación como autorización para empezar el manuscrito automáticamente.
