...
**Estado · 18 septiembre 2026:** análisis, atlas y piloto de propiedades de la forma terminados. Apertura y reparto entre direcciones aportan resultados; la fragmentación no queda resuelta por un índice único. El manuscrito y el depósito público de datos siguen pendientes. [Estado exacto y continuación →](NEXT_STEPS.md)
...
El piloto nuevo muestra que cambiar de modelo puede invertir el orden de dos áreas según su apertura, aun cuando repetir la selección de artículos no lo cambia. También demuestra límites de las medidas simples de fragmentación. [Resultados y casos →](MORPHOLOGY_RESULTS.md)
