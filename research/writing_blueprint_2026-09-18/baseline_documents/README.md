...
| Preparar la redacción | [Cómo argumentan los artículos de QSS](QSS_STRUCTURE_REVIEW.md) · [Esquema aplicado](PAPER_OUTLINE.md) · [Qué falta antes de enviar](docs/QSS_CHECK.md) |
