# Estado actual: resumen final terminado; organizar el manuscrito

**18-09-2026.** Cierre experimental R01–R12, atlas y piloto de morfología conservados; resumen de las 325 parejas completado y auditado. El usuario quiere ahora discutir cómo organizar el manuscrito con toda la evidencia. No hay cálculos activos ni texto del paper iniciado.

## Punto exacto para continuar

1. Leer [FIELD_PAIR_RESULTS.md](FIELD_PAIR_RESULTS.md) y [METHODS_FIELD_PAIRS.md](METHODS_FIELD_PAIRS.md); después el [piloto](MORPHOLOGY_RESULTS.md) y [PREPAPER_REVIEW.md](PREPAPER_REVIEW.md): comprobaciones y errores de la fuente detectados.
...
3. Acordar con el usuario la organización, partiendo de [PAPER_OUTLINE.md](PAPER_OUTLINE.md). Redactar solo cuando se solicite, con los métodos actuales y [references/RELATED_WORK.md](references/RELATED_WORK.md). Usar [references/references.bib](references/references.bib). La ampliación experimental acordada ha terminado.
