...
Los dos documentos tienen estructura, tablas y figuras reales. Introducción y antecedentes/preguntas están redactados como primer borrador de unas 1.000 palabras, por petición del autor. El resto de la prosa sigue pendiente y aparece como *Writing plan*. Los nombres de autores, afiliaciones y declaraciones no se han rellenado por suposición.
...
La bibliografía base procede de la biblioteca canónica de 54 entradas; solo se ha escapado un guion largo para su composición tipográfica. `context_references.bib` añade Held y Velden (2022), tomado de la revisión QSS ya verificada y sin duplicado en la biblioteca base. El PDF imprime 17 referencias únicas: ocho de la apertura y nueve de la tabla de modelos. Las fuentes de las demás secciones se incorporarán al escribir y comprobar sus frases; no se añaden automáticamente todos los antecedentes leídos.
...
La revisión de la voz sigue [AUTHOR_VOICE.md](../AUTHOR_VOICE.md); el contenido y las citas previstas, [MANUSCRIPT_BLUEPRINT.md](../MANUSCRIPT_BLUEPRINT.md). Revisar ahora los dos bloques redactados y continuar con las secciones que pida el autor. Los enlaces a documentos situados fuera de esta carpeta corresponden al repositorio completo. Autoría, declaraciones, depósito, licencia y envío siguen pendientes.
