...
**Estado vigente, 18-09-2026:** revisión de estructura y argumentación de QSS terminada; propuesta aplicada en `PAPER_OUTLINE.md`, todavía por conversar con el usuario. Leer `QSS_STRUCTURE_REVIEW.md`, `NEXT_STEPS.md` y el final de `progress.md`/`DECISIONS.md`. Cierres científicos, atlas, morfología y 325 parejas conservados. Las medidas describen geometría, no verdad temática. Mantener alertas y errores de OpenAlex; no reiniciar cálculos ni redactar automáticamente.
