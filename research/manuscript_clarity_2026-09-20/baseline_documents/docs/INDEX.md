...
**Última entrega de escritura, 19-09-2026:** [tres alternativas de voz en inglés y español](../MANUSCRIPT_VOICES.md), completas y revisadas. El título está confirmado; la voz elegida y la aprobación del autor siguen pendientes.

**Borrador canónico conservado:** [manuscrito completo](../MANUSCRIPT_LAYOUT.md) y [revisión editorial/visual](../MANUSCRIPT_REVIEW.md), 18-09-2026. Los cierres anteriores permanecen como historial.

**Para la lectura del autor:** [traducción completa al español](../MANUSCRIPT_SPANISH.md), con artículo, suplemento, tablas y figuras. Comentarios del autor aplicados a ambas versiones; copias anteriores archivadas. [Últimos cambios](../MANUSCRIPT_COMMENTS.md).
...
10. [Voz del autor](../AUTHOR_VOICE.md): lectura de 50 entradas del portfolio y reglas usadas para adaptar esa voz a QSS; [investigación sobre escritura](../research/writing_blueprint_2026-09-18/STYLE_RESEARCH.md). Pendiente de valoración personal del autor.

11. [Manuscrito completo y paquete editable](../MANUSCRIPT_LAYOUT.md): cuerpo, resumen, declaraciones y suplemento escritos. [Revisión editorial/visual](../MANUSCRIPT_REVIEW.md) y [comprobación de afirmaciones](../research/manuscript_full_2026-09-18/CLAIM_REVIEW.md). La apertura anterior se conserva como historial.
