...
**Estado vigente, 17-09-2026:** revisión previa al manuscrito y atlas de casos terminados; cierre R01–R12 conservado. Leer `PREPAPER_REVIEW.md`, `CASE_ATLAS.md`, `references/RELATED_WORK.md`, `NEXT_STEPS.md` y el final de `progress.md`/`DECISIONS.md`. Se detectaron errores de etiquetas y avisos en la fuente OpenAlex; no ocultarlos ni confundir integridad técnica con validez temática. No reiniciar cálculos ni redactar automáticamente.
