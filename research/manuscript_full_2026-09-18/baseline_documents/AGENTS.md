...
**Estado vigente, 18-09-2026:** introducción y `Background and research questions` redactados por petición directa, como primer borrador de unas 1.000 palabras conjuntas. Están en `manuscript/main.tex` y el PDF principal; las demás secciones conservan planes. Leer `MANUSCRIPT_LAYOUT.md`, `AUTHOR_VOICE.md` y `NEXT_STEPS.md`. Tablas, figuras, resultados y suplemento conservados. Maqueta propia para primera entrega flexible, no plantilla oficial QSS. No reiniciar cálculos ni extender automáticamente la redacción a otros bloques.
...
- La preparación de estructura/voz no autoriza redactar automáticamente el artículo completo. El usuario ha pedido después comenzar expresamente por introducción y antecedentes, sustituyendo para esa entrega el orden recomendado de métodos/resultados. Continuar solo con los bloques que solicite, comprobando la adaptación de su voz. Título final, autoría, depósito, licencia y envío no se rellenan por suposición.
