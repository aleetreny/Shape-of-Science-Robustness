...
**Precisión de la petición sobre el abstract, 20-09-2026:** la explicación debe identificar qué se hace, con qué objeto y frente a qué alternativa. «Quitar el resumen» debe decir que el modelo recibe solo el título de cada artículo frente a título y resumen. Presentar las disciplinas con ejemplos antes de llamarlas áreas; explicar qué resumimos en un centro y qué significa invertir una comparación. Sustituir «otro procesamiento» por la operación pertinente cuando se mencione su resultado. El autor conserva el tono, pero pide estos pasos de explicación. Aplicado en `ABSTRACT_CLARITY.md`; no es autorización para cambiar métodos ni resultados.
