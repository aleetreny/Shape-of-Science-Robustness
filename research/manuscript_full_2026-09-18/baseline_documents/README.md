...
**Estado · 18 septiembre 2026:** análisis y revisión terminados; introducción y antecedentes redactados en un primer borrador breve. [Artículo, suplemento y fuentes](MANUSCRIPT_LAYOUT.md), con las tablas y figuras colocadas. Las demás secciones siguen pendientes de redacción. La fragmentación no queda resuelta por un índice único; el depósito de datos sigue pendiente. [Estado exacto y continuación →](NEXT_STEPS.md)
...
| Preparar la redacción | [Plano detallado del manuscrito](MANUSCRIPT_BLUEPRINT.md) · [Voz del autor](AUTHOR_VOICE.md) · [Estructuras de QSS](QSS_STRUCTURE_REVIEW.md) · [Qué falta antes de enviar](docs/QSS_CHECK.md) |
...
- `manuscript/`: maqueta LaTeX, figuras y tablas del paper; `output/`: PDF y paquete editable.
