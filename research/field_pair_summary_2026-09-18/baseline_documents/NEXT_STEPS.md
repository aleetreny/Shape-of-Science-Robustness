# Estado actual: piloto de morfología terminado

**18-09-2026.** Cierre experimental R01–R12 y atlas conservados; piloto nuevo de morfología completado y auditado. No hay cálculos activos. El manuscrito no se ha empezado.

## Punto exacto para continuar

1. Leer [MORPHOLOGY_RESULTS.md](MORPHOLOGY_RESULTS.md) y [METHODS_MORPHOLOGY.md](METHODS_MORPHOLOGY.md); después [PREPAPER_REVIEW.md](PREPAPER_REVIEW.md): comprobaciones y errores de la fuente detectados.
...
3. Redactar solo cuando se solicite, siguiendo [PAPER_OUTLINE.md](PAPER_OUTLINE.md), los métodos de las fases conservadas y del piloto nuevo y [references/RELATED_WORK.md](references/RELATED_WORK.md). Usar [references/references.bib](references/references.bib).
