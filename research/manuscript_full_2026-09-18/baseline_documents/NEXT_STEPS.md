# Estado actual: introducción y antecedentes redactados

**18-09-2026.** Primer borrador de `Introduction` y `Background and research questions`: unas 1.000 palabras conjuntas, por petición directa. [MANUSCRIPT_LAYOUT.md](MANUSCRIPT_LAYOUT.md) enlaza el PDF actualizado y las fuentes. Las demás secciones siguen como plan. Principal: dos tablas/cuatro figuras; suplemento: 17 grupos de tablas/diez figuras, con CSV completos. Los resultados se conservan; no se repitió ningún experimento.
...
3. Revisar con el autor las secciones 1 y 2 ya escritas, y continuar con los bloques que solicite. La petición de empezar por introducción/antecedentes sustituyó la recomendación previa de métodos/resultados. Usar el plano y su [matriz de evidencia](research/writing_blueprint_2026-09-18/claim_evidence.csv). Para geometría consultar [FIELD_PAIR_RESULTS.md](FIELD_PAIR_RESULTS.md), [METHODS_FIELD_PAIRS.md](METHODS_FIELD_PAIRS.md) y [MORPHOLOGY_RESULTS.md](MORPHOLOGY_RESULTS.md). Biblioteca canónica: 54 entradas; revisión QSS: 34 con solapamientos. La apertura cita ocho trabajos; junto con la tabla de modelos se imprimen 17 referencias únicas. Una entrada adicional procede de la revisión QSS y está en `manuscript/context_references.bib`. No incorporar automáticamente todas las fuentes leídas.
