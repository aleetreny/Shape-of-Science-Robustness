# Estado actual: plano de escritura y voz del autor preparados

**18-09-2026.** El usuario pidió desarrollar la estructura y conservar su forma de escribir. [MANUSCRIPT_BLUEPRINT.md](MANUSCRIPT_BLUEPRINT.md) organiza 48 párrafos, seis secciones, dos tablas y cuatro figuras principales, con evidencia y suplemento. [AUTHOR_VOICE.md](AUTHOR_VOICE.md) se basa en las 50 entradas españolas del portfolio y una revisión dirigida de cuatro estudios sobre escritura. La revisión previa de QSS conserva sus 34 artículos seleccionados, 33 lecturas estructurales y un acceso parcial. No se ha redactado el manuscrito ni cambiado ningún resultado científico.

## Punto exacto para continuar

1. Leer [MANUSCRIPT_BLUEPRINT.md](MANUSCRIPT_BLUEPRINT.md) y [AUTHOR_VOICE.md](AUTHOR_VOICE.md). Para el fundamento editorial, [QSS_STRUCTURE_REVIEW.md](QSS_STRUCTURE_REVIEW.md). Distinguir normas oficiales consultadas mediante índice antiguo, prácticas observadas y propuesta propia. Los 465 registros del marco no son 465 artículos leídos; las versiones de autor no certifican la estructura editorial final.
