...
**Corrección del cargador Zenodo, 21-09-2026:** después de los cortes reales con dos conexiones, `upload_zenodo.sh` envía obligatoriamente un archivo cada vez, de menor a mayor tamaño. Diecisiete pruebas aprobadas; prueba real de 358 s sobre MiniLM hasta 12,9 % sin cortes, detenida manualmente. No se ha verificado un ZIP grande completo. Estado: 18/32 completos comprobados, 14 pendientes (51,08 GB), sin subida activa. Mismo comando en `ZENODO_UPLOAD.md`; evidencia en `research/zenodo_upload_fix_2026-09-21/verification.json`. No volver a activar varias conexiones ni reiniciar la carga completa por retomar. El autor la ejecuta; el registro sigue sin publicar.

**Carga por API preparada y probada, 21-09-2026:** el autor facilita una clave y pide guardarla y crear/probar un script para ejecutar él la carga grande. Clave guardada en el Llavero de macOS, servicio `shape-of-science-zenodo-22863543`, cuenta `zenodo.org`; nunca incluirla en el repositorio o mensajes. `./upload_zenodo.sh` sube solo pendientes de la lista congelada, dos a la vez, con huellas y reintentos; `--status` solo consulta. Prueba real: `field_pair_summary_v1.zip`, 3,35 MB, subido y verificado; al repetir se omite. Once pruebas locales aprobadas. Borrador 22863543: 18/32 completos, quedan 14 y 51.078.598.017 bytes. El autor ejecutará los grandes; no iniciarlos por retomar. No publica. La reanudación conserva archivos completos, pero un ZIP interrumpido empieza desde cero. Ignora `robustness_v2.zip.partial`, ajeno a la lista. Guía vigente: `ZENODO_UPLOAD.md`; evidencia: `research/zenodo_upload_2026-09-21/verification.json`.

**Cinco comentarios nuevos del autor aplicados, 21-09-2026:** resumen con explicación de los ángulos y del cambio de punto de referencia; propósito de ampliar la muestra; elección por uso en los estudios de mapas de la ciencia revisados; motivo de MiniLM con 512 tokens; «una primera prueba» en texto y tabla. Ambos idiomas sincronizados. Entrega: `MANUSCRIPT_COMMENTS_2026-09-21.md`; PDF EN 24 páginas/196 palabras de resumen, ES 26/214. Cifras, fórmulas, figuras y suplementos conservados; fuentes editables reconstruyen los cuatro PDF exactamente. Los 32 archivos de Zenodo permanecen sin cambios y siguen excluyendo el artículo. Revisión local, sin nuevo commit/push ni envío. «Más utilizados» queda limitado a los antecedentes revisados, no a un censo de la literatura.

**Paquete de Zenodo revisado por petición expresa, 21-09-2026:** excluir artículos y suplementos EN/ES, fuentes editables, alternativas, copias anteriores y registros internos del paquete de subida. Ya preparado `output/zenodo/shape-of-science-code-v1.0.0-data-only.zip`; sustituye al ZIP completo del repositorio. La carpeta final contiene 32 archivos, 51,19 GB; los 19 ZIP numéricos se mantienen. Antiguo ZIP y documentos de entrega preservados en `data/public_release_history/2026-09-20/`, fuera de la subida. `AGENTS.md`, planes y notas editoriales no van en el ZIP nuevo. Auditoría en `research/package_cleanup_2026-09-21/`; prueba pequeña desde el ZIP aprobada, 582 archivos originales de manuscrito intactos. La revisión de referencias explícitas es acotada, no una prueba de autoría sin asistencia ni una alteración del historial real. No usar el antiguo `finalize_upload.py` para recrear un ZIP completo. Continuar con `ZENODO_UPLOAD.md`; el borrador sigue con cero archivos, DOI solo reservado.

**Publicación y novedad autorizadas, 20-09-2026:** el autor pide integrar los tres párrafos propuestos en inglés y español, actualizar GitHub y completar cuanto sea posible del depósito reproducible. Confirma expresamente MIT para el código propio y CC BY 4.0 para resultados/documentos; los metadatos OpenAlex conservan CC0. Esta autorización sustituye las restricciones anteriores de solo propuesta para esta entrega. No autoriza envío a revista ni cambios científicos. Trabajo en `research/public_release_2026-09-20/` y `output/zenodo/`; preservar datos y programas congelados.

**GitHub verificado, 20-09-2026:** entrega de código `cc61517` publicada, PDF y archivos clave iguales a sus copias públicas. `output/zenodo/` contiene los 32 archivos finales (51,41 GB), incluido el ZIP de ese commit. La continuación es la carga manual/publicación descrita en `ZENODO_UPLOAD.md`, seguida de comprobar el registro público y actualizar disponibilidad/cita/S8. No repetir preparación, pruebas o licencias por retomar.

**Continuación del depósito, 20-09-2026:** párrafos de novedad integrados en ambos idiomas; 19 ZIP (51,14 GB, 58.201 archivos) verificados. Licencias MIT y CC BY 4.0 confirmadas expresamente. Borrador Zenodo `22863543`, DOI `10.5281/zenodo.22863543` solo reservado, 75 GB de cuota y cero archivos subidos. El selector automático no respondió; continuar con `ZENODO_UPLOAD.md`. No afirmar acceso público hasta publicar/verificar. `PUBLIC_RELEASE.md` y `reproducibility/README.md` delimitan pruebas y límites; no se ha certificado una repetición completa de todos los análisis. No reabrir licencias ni experimentos.

# Cómo trabajar en este proyecto

**Revisión previa al envío, 20-09-2026:** el autor pide aclarar la novedad y explorar la reproducción pública. Entrega: [NOVELTY_AND_REPRODUCIBILITY.md](NOVELTY_AND_REPRODUCIBILITY.md). Contraste dirigido con antecedentes y redacción EN/ES propuesta, sin modificar el artículo. GitHub sigue en `44c9410` (17-09): faltan las fases de geometría y cierre posterior. Sin licencia general ni depósito persistente. Propuesta GitHub + Zenodo, inventario y demostración local de parte de Figura 4 preparados; no equivalen a reproducción pública completa. La guía QSS sigue inaccesible directamente (403); se consultó su versión oficial indexada. No publicar, elegir licencia o enviar por extensión de esta revisión. Continuar con la integración editorial o preparación del paquete cuando el autor lo solicite.
