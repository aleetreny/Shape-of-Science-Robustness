...
La traducción española definitiva, approved by the author on 21 September 2026. English is the authoritative version for journal submission, preprinting and citation. The Spanish version is a professional translation for the author.
...
From the repository root run `./manuscript_es/build.sh`. In Overleaf, use XeLaTeX and select `main.tex` or `supplement.tex` as the main document.
